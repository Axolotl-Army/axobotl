...
function EmbedPreview({
  ...
  const progressPercent = Math.round(
    (PREVIEW_XP_INTO / PREVIEW_XP_NEEDED) * 100,
  );
  return (
    <div
      style={{
    ...
    >
      ...
      <div style={{ padding: '12px 16px', flex: 1, minWidth: 0 }}>
        ...
        <div style={{ color: '#dbdee1', fontSize: 14, lineHeight: 1.7 }}>
          <div>
            <strong>Total XP:</strong> {PREVIEW_XP.toLocaleString()}
          </div>
          <div>
            <strong>Guild Rank:</strong> #7
          </div>
          <div>
            <strong>Progress to Level {PREVIEW_LEVEL + 1}:</strong>{' '}
            {PREVIEW_XP_INTO.toLocaleString()} /{' '}
            {PREVIEW_XP_NEEDED.toLocaleString()} XP
          </div>
        </div>
      </div>
    </div>
        ...
        {guildsLoading || loading ? (
          ...
          <>
            ...
            <Card className='mb-4'>
              ...
              <Card.Body>
                <p className='text-muted mb-3'>
                  Choose a default colour for bot embeds. Commands that specify
                  their own colour will override this setting.
                </p>
            ...
            <Card className='mb-4'>
              ...
              <Card.Body>
                <p className='text-muted mb-3'>
                  Enable or disable base commands for this guild. Disabled
                  commands will not respond when used.
                </p>
